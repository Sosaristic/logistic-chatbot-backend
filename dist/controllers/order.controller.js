    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, vendors_models_1.VendorModel.findOne({ api_key: apiKey })];
            case 1:
                vendor = _a.sent();
                if (!vendor) {
                    throw new error_1.default('Unauthorized', 401);
                }
                return [4 /*yield*/, order_model_1.Order.create({
                        ...
                        status: 'pending',
                        vendor: vendor._id,
                        trackingId: (0, helpers_1.generateTrackingId)(12),
                    })];
            case 2:
                order = _a.sent();
