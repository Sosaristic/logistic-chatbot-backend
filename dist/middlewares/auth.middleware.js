...
exports.authMiddleWare = (0, express_async_handler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, accessToken, refreshToken, decoded, error_2, decoded, user, newAccessToken, newRefreshToken, hashedToken;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                error_2 = _b.sent();
                if (!(error_2.name === 'TokenExpiredError')) return [3 /*break*/, 6];
                if (!refreshToken) {
                    throw new error_1.default('unauthorized', 401);
                }
